    ...
    <div className='containerFluid'>
        <Navbar bg="dark" variant="dark"  expand="sm">
           ...
           <Container>
            ...
            <Navbar.Brand href="icon/logo.jpg">Online Result System</Navbar.Brand>
                      ...
                      <Navbar.Collapse id="responsive-navbar-nav" >
                        <Nav className="d-flex" activeKey="/home">
                         {/* <Nav.Link to="/binding" > Binding </Nav.Link> */}
                          ...
                          <NavDropdown.Divider />
                          <NavDropdown.Item> <Link to="/UserList" > UserList </Link></NavDropdown.Item>
                          </NavDropdown>
                        ...
                        <Nav.Link>Hi {localStorage.getItem('Name')}  <FaUserTie className='fa-duotone fa-user'/></Nav.Link>
                        <Nav.Link onClick={this.logout}>Logout <FiLogOut/></Nav.Link>
                        </Nav>
                        </Navbar.Collapse>
                      </Container>
